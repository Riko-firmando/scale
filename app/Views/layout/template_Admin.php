    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar" style="background-color: teal; ">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                <div class="sidebar-brand-text mx-3" id="brand">scale</div>
            </a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url("Admin/listOrder"); ?>">
    ...
    <script>
        $(document).ready(function() {
            $(window).scroll(function() {
                let wsScrolltop = $(window).scrollTop();
                // let wsScrolldown = $(window).scrolldown();
                // $('#accordionSidebar').css('position', 'relative')
                $('#accordionSidebar').css('top', wsScrolltop + 'px')
                // $('#accordionSidebar').css('bottom', wsScrolldown + 'px')
            })
        })
    </script>
</body>
